        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
          <Form>
            <div className="form-group">
              ...
              <Field as="select" name="rating" id="rating" className="form-control">
                <option value={0} className="rating-option">0</option>
                <option value={1} className="rating-option">1</option>
                <option value={2} className="rating-option">2</option>
                <option value={3} className="rating-option">3</option>
                <option value={4} className="rating-option">4</option>
                <option value={5} className="rating-option">5</option>
              </Field>
